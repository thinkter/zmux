...
impl Workspace {
    ...
    /// zmux extension: expose the center pane group so callers can read and
    /// write split structure and flex sizes directly instead of relying on
    /// paint-time bounding boxes.
